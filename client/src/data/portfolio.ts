...
export const portfolio: PortfolioProject[] = [
  {
    ...
    testimonial: {
      author: "天喜の記憶記憶守護團隊",
      rating: 5,
      text: "天喜旅行社已經結束營業，但郭先生對客戶的那份溫柔從未消失。王純瑋用網站把這份溫度永久保存了下來。他不是在做一個網站，而是在守護一個時代的記憶。",
    },
  },
  {
    id: "soyui",
    ...
    testimonial: {
      author: "SOYUI COFFEE 創辦人",
      rating: 5,
      text: "王純瑋不只是設計師，他是品牌故事的翻譯家。我們想表達『平價但不妥協』的理念，他卻理解得比我們還深。網站上線後，客戶們說『這個官網讓我更喜歡所以咖啡了』。",
    },
  },
  {
    id: "openlock",
    ...
    testimonial: {
      author: "OpenLock 客戶",
      rating: 5,
      text: "在最急的時候看到這個網站，清楚的資訊和快速的聯絡方式讓我很放心。專業、透明、可信任。",
    },
  },
  {
    id: "wenwei",
