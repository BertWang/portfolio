...
export default function Home() {
  ...
  const regionContent = {
    tw: {
      since: 'SINCE 2004',
      title: '修繕生活的溫度，設計品牌的靈魂',
      subtitle: '18 年網頁設計與 PHP 開發經驗，為台灣在地品牌創造具有溫度的數位體驗',
      serviceArea: '服務地區',
      serviceAreaDesc: '台南市全區（東區、永康、新化、善化、南科周邊...）',
      cta1: '立即來電',
      cta2: '傳照佐傳',
      aboutTitle: '關於我',
    ...
    jp: {
      ...
      serviceAreaDesc: 'Tainan City (East District, Yongkang, Xinhua, Shanhua, Tainan Science Park area...)',
      cta1: 'Call Now',
      cta2: 'Send Photos',
      aboutTitle: 'About Me',
    ...
    my: {
      ...
      serviceAreaDesc: 'Seluruh Tainan (Kawasan Timur, Yongkang, Xinhua, Shanhua, Kawasan Taman Sains Tainan...)',
      cta1: 'Hubungi Sekarang',
      cta2: 'Kirim Foto',
        ...
        <div className="container px-4">
          <div className="max-w-2xl">
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-6">
              ...
              >
                <Phone size={28} className="text-[#8B7355] group-hover:scale-110 transition-transform" />
                <span className="font-semibold text-gray-900 text-center">{content.cta1}</span>
                <span className="text-sm text-gray-600">0901-404-663</span>
              </a>
              <a
              ...
              >
                ...
                <span className="font-semibold text-center">{content.cta2}</span>
                <span className="text-sm text-white/80">weblink1982@gmail.com</span>
              </a>
            </div>
          </div>
        </div>
